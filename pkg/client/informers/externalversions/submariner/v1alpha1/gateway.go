	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SubmarinerV1alpha1().Gateways(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SubmarinerV1alpha1().Gateways(namespace).Watch(options)
			},
		},
		&submarinerv1alpha1.Gateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&submarinerv1alpha1.Gateway{}, f.defaultInformer)
}
